...
extern "C" {
#endif // __cplusplus
    extern void compute_fractal(int32_t width, int32_t height, int32_t n, float x_min, float x_max, float y_min, float y_max, int32_t max_iter, float epsilon, float * roots_real, float * roots_imag, int32_t num_roots, int32_t * output);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
